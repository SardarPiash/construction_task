  ...
  return (
    <div>
      <div className="bg-white py-16">
        ...
        <div className=" flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-0 px-4 md:px-12">
  {datas.map((data, index) => (
    <div
      key={index}
      className="relative  shadow-lg p-8  rounded-lg flex-1"
    >
      {/* Small white div */}
      <div
      ...
      <div className="relative z-10"> 
        <div className="flex justify-center mb-4 ">
          <div
            ...
            style={{ width: "75px", height: "75px",boxShadow:
